package me.galaxy.playagainaddon.commands;
...
public class ReloadCommand extends SubCommand {
    ...
    public boolean execute(String[] strings, CommandSender commandSender) {
        PlayAgainAddon.getInstance().config.load();
        commandSender.sendMessage(TextUtil.color(PlayAgainAddon.getInstance().config.getYml().getString("messages.config-reloaded")));
        return true;
    }
